...
=========================================================================*/
// .NAME HDLReader - class for reading Velodyne HDL data
// .Section Description
//
...
public:
  ...
  void setHDLProcessor(boost::shared_ptr<HDLProcessor> p);
...
private:
  ...
  HDLReader(const HDLReader&);
  void operator = (const HDLReader&);
